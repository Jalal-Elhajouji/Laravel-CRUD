...
<body class="bg-dark text-white mt-5">
    <div class="container text-center d-grid col-6">
            ...
            <div class="col ">
                ...
                <form action="/add/treatment" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control bg-dark text-light" name="fname">
                    </div>
                    <div class="mb-4">
                        <label for="lname" class="form-label">Last name</label>
                        <input type="text" class="form-control bg-dark text-light" name="lname">
                    </div>
                    <div class="mb-4">
        ...
        <a href="/" class="btn btn-warning my-2">Back to home page</a>
    </div>
